...
Most of these come down to network reality or how gapminder serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

gapminder rate-limits like any public site. gapminder already paces
...
Where a surface is gated, gapminder reads a cookie or token you supply
...
`gapminder`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what gapminder actually did
